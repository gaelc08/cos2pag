...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--lifecycle-days", type=int, default=None, help="Override pag.lifecycle_days for this run only (auto-delete objects after this many days)")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        report = sync_bucket(
            config, args.bucket_name, args.tenant, dry_run=args.dry_run, lifecycle_days=args.lifecycle_days
        )
