...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--delete-delay-days", type=int, default=None, help="Override pdr.copy_options.delete_delay_days for this run only")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        report = sync_bucket(
            config, args.bucket_name, args.tenant, dry_run=args.dry_run, delete_delay_days=args.delete_delay_days
        )
